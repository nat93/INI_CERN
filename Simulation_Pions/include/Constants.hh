...
namespace Constants
{
    ...
    static const G4double _prim_particle_pos_X_sigma = 2.06311*mm;
    static const G4double _prim_particle_ang_X_sigma = (28.8223e-6)*rad;
    static const G4double _prim_particle_pos_Y = 0.0*mm;
    static const G4double _prim_particle_pos_Y_sigma = 2.34556*mm;
    static const G4double _prim_particle_ang_Y_sigma = (41.0371e-6)*rad;
    ...
    static const G4double _small_plastic_scint_pos_Z =      165.0*mm;
    static const G4double _small_plastic_scint_gap_X =        4.0*mm;
    static const G4double _small_plastic_scint_shift_X =      0.0*mm;
    ...
    // Crystal position QMPLHC
    static const G4double _crystal_qmp_pos_X = -2.5*mm;
