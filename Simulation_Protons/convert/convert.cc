...
const Int_t nPoint = 50;
const Int_t nWidth = 6;
...
{    
    ...
    for(Int_t i = 0; i < nentries; i++)
    {
        ...
        if(i%1000000 == 0) cout<<"--> "<<(double)100.0*i/nentries<<" %"<<endl;
    }
