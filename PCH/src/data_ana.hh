...
public:
    ...
    void find_inelastic_frequency1(Double_t *N12, Double_t *N0);
    void find_inelastic_frequency2(Double_t *N12, Double_t *N0);
    void find_inelastic_frequency3(Double_t *N12, Double_t *N0);
    ...
    static const Double_t theta_cut_max = 80.0e-6;      // rad
